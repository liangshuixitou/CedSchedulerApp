...
conda activate cedschedulerapp && \
cd ~/project/CedSchedulerApp/cedschedulerapp/worker && \
...
conda activate cedschedulerapp && \
cd ~/project/CedSchedulerApp/cedschedulerapp/worker && \
python app.py --master-host 120.220.95.189 --master-port 12002 --region 2 --type 推理 --id inference-node-1

conda activate cedschedulerapp && \
cd ~/Project/Python/CedSchedulerApp/cedschedulerapp/worker && \
python app.py --master-host 120.220.95.189 --master-port 12002 --region 3 --type 推理 --id inference-node-2
